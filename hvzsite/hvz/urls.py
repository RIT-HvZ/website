...
urlpatterns = [
    ...
    re_path(r'player/<player_id>/?', views.player_view),
    re_path(r'me/?', views.me),
    re_path(r'team/<team_name>/?', views.team_view),
    ...
    re_path(r'admin/player_admin/tools/<player_id>/<command>/?', views.player_admin_tools),
    re_path(r'admin/bodyarmors/?', views.bodyarmors),
    re_path(r'admin/bodyarmor/<armor_id>/?', views.bodyarmor_view),
    re_path(r'admin/editmissions/?', views.editmissions),
    re_path(r'admin/editmission/<mission_id>/?', views.editmission),
    re_path(r'admin/editpostgamesurvey/<postgamesurvey_id>/?', views.editpostgamesurvey),
    re_path(r'admin/editpostgamesurveys/?', views.editpostgamesurveys),
    re_path(r'admin/reports/?', views.reports),
    re_path(r'admin/report/<report_id>/?', views.report),
